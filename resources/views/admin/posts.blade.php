...
<div class="container mt-5">
    ...
    <ul class="nav nav-tabs mb-4">
        <li class="nav-item">
            <a class="nav-link active" data-toggle="tab" href="/admin/post/all">همه پست‌ها</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="/admin/post/accepted-posts">پست‌های تایید شده</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="/admin/post/pendding-posts">پست‌های در انتظار تایید</a>
        </li>
    </ul>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @if($post->status == 'در انتظار')
                        <td>
                            <form action="{{$post->id}}/accept" method="POST">
                                @csrf
                                @method('PATCH')
                        ...
                        @else
                        <td class="bg-success">تایید شده</td>
                        @endif
                    </tr>
                    @endforeach
